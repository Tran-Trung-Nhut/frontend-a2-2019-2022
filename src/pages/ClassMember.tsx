    ...
    >
      ...
      <div className="w-full max-w-screen min-h-screen px-4 py-8 text-center bg-black bg-opacity-60 shadow-2xl" onClick={() => setDropdownOpen(false)}>
        ...
        <div className="mt-8">
          <button
            type="button"
            className="bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-800 text-white text-2xl font-extrabold py-4 px-10 rounded-full shadow-2xl transform hover:scale-110 hover:rotate-6 hover:shadow-2xl hover:ring-4 hover:ring-blue-300 transition-all duration-500 ease-in-out"
